/**
     ...
     Kelas       : IF-6k
     Tanggal     : 28/04/2020
     Deskripsi   : membuat kelas Preferences pada packet com.chupakubera.latihansharedpreference.utils
 */

package com.chupakubera.latihansharedpreference.util;
...
public class Preferences {
    ...
    private static final String PREF_SESSION = "com.chupakubera.latihansharedpreference.session";
